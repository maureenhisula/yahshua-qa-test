...
### Evidence
The automated test test_calculate_payroll_missing_employee_should_return_404 also fails because the API returns 200 instead of 404.
...
### Evidence
The automated test test_negative_salary_should_be_rejected fails because the API returns 201 instead of 400.
...
# API and Boundary Testing Summary
